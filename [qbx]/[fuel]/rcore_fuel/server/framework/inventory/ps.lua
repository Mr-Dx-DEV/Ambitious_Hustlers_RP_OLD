if Config.InventorySystem == Inventory.PS then
    local resourceName = InventoryResourceNames[Inventory.PS]
    ...
    RegisterNetEvent("ps-inventory:server:UseItemSlot", function(activeSlot)
