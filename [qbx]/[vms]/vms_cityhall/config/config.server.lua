...
--  ╚══╝╚══╝ ╚══════╝╚═════╝ ╚═╝  ╚═╝ ╚═════╝  ╚═════╝ ╚═╝  ╚═╝╚══════╝
SV.Webhooks = {
    ['JOINED_JOB'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['SENT_RESUME'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['ORDER_DOCUMENT'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['GET_DOCUMENT'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['PICKUP_DOCUMENT'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['INVALIDATION_DOCUMENT'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['REREGISTRATION_VEHICLE'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['PAYCHECK_WITHDRAW'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['BUY_HEALTH_INSURANCE'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['BUY_VEHICLE_INSURANCE'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['RECEIPT'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['PAY_RECEIPT'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['INVOICE'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['PAY_IVOICE'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['TICKET'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['TRAFFIC_TICKET'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['PAY_TICKET'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['PAY_TAX'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['PAY_COMPANY_TAX'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['VEHICLE_SELL'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['ANNOUNCEMENT'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['EMPLOYEE_HIRE'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['EMPLOYEE_BONUS'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['EMPLOYEE_CHANGE_GRADE'] = "YOUR_DISCORD_WEBHOOK_URL",
    ['EMPLOYEE_FIRE'] = "YOUR_DISCORD_WEBHOOK_URL",
