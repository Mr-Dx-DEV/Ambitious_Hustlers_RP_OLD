...
Config.CityHallPoints = {
    {
        ...
        blipCoords = vector3(-234.882, -922.289, 32.312), -- Coordinates where the blip will be displayed on the map
        ...
        menuCoords = vec3(-234.882, -922.289, 32.312), -- Coordinates where the main menu interface opens
        targetCoords = vec4(-236.297, -921.66, 32.81, 337.485), -- Position of the interaction target for third-party targeting systems
        ...
        ped = { -- Configuration for an NPC (ped) at the City Hall
            ...
            coords = vec4(-236.297, -921.66, 31.30, 337.485), -- Spawn location and heading for the NPC
        ...
        menusAvailable = { -- List of available menus that can be accessed at this City Hall
            ...
            insurance = false, -- Enable the insurance menu
...
Config.UsePaychecks = true -- Enable automated paycheck system
...
Config.JobsList = {
    ...
    {type = "Truck", label = "Trucker", name = "Trucker", grade = 0, requiredResume = false},
    {type = "Taxi", label = "Taxi", name = "Taxi", grade = 0, requiredResume = false},
    {type = "Tower", label = "Tow Truck", name = "Tow", grade = 0, requiredResume = false},
    {type = "News", label = "News Reporter", name = "Reporter", grade = 0, requiredResume = false},
    {type = "Garabge", label = "Garbage Collector", name = "Garbage", grade = 0, requiredResume = false},
    {type = "Bus", label = "Bus Driver", name = "Bus Driver", grade = 0, requiredResume = false},
    {type = "Shop", label = "Hot Dog Stand", name = "Hot Dog Stand", grade = 0, requiredResume = false},
...
Config.ReregistrationPlateModes = {
    ...
    ['custom'] = {allow = true, price = 8000},   -- Choose a custom plate for 8000
}
...
Config.AllowToChangePlate = true -- Allow manual plate changes
...
Config.ChangePlatesModes = {
    ...
    ['custom'] = {allow = true, price = 12000},  -- Custom plate for 12000
}
...
Config.BillingsRequiredConfirm = false -- Require confirmation before issuing a bill
...
Config.AllowedJobBillings = {
    ['police'] = {
        ...
        amountLimits = {
            ['traffic-ticket'] = {min = 1, max = 1200000},
            ['ticket'] = {min = 1, max = 50000000},
        },
