        ...
        if vehicles then
            ...
            for _, option in ipairs(vehicles) do
                ...
                OpenInsuranceMenu.options[#OpenInsuranceMenu.options + 1] = {
                    title = "Plate: " .. option.plate .. " | Model: " .. GetLabelText(GetDisplayNameFromVehicleModel(option.model)),
        ...
        options = {
            {
                ...
                onSelect = function()
                    ...
                    if input then
                        local price = Config.healthInsurance.insuranceTypes[1].price * input[3]
