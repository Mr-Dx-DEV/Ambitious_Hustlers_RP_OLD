...
Language = {
    ["pt"] = {
        ...
        hasInsurance = "Este veículo tem seguro!",
        hasntInsurance = "Este veíclo não tem seguro!",

        closeCamera = "[BACKSPACE] - Fechar Câmera",
    },
    ["en"] = {
        -- Targets
        ...
        hasInsurance = "This car has insurance.",
        hasntInsurance = "This car hasn't insurance.",
        closeCamera = "[BACKSPACE] - Close Camera",
    }  
}
