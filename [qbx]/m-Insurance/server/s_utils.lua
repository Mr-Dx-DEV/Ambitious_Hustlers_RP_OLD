...
WebhookURLs = {
    ["car-registration"] = "YOUR_DISCORD_WEBHOOK_URL",
    ["car-insurance"] = "YOUR_DISCORD_WEBHOOK_URL",
    ["car-accidents"] = "YOUR_DISCORD_WEBHOOK_URL",
    ["health-insurance"] = "YOUR_DISCORD_WEBHOOK_URL",
...
-- This is the callback of event m-Insurance:Client:HaveCarInsurance if you add it to radialmenu or somethign
local QBCore = exports[Config.Core]:GetCoreObject()

QBCore.Functions.CreateCallback("m-Insurance:Server:HaveCarInsurance", function(source, cb, plate)
    exports['m-Insurance']:HasCarInsurance(plate, function(hasInsurance)
        cb(hasInsurance)
    end)
end)
