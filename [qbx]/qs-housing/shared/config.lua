...
Config.Framework = dependencyCheck(frameworks) or 'qb'
Config.FiveGuard = false            -- Your fiveguard script name if exists, if not false.
Config.DisableInteractSound = false -- disables the usage of interact sound (for fiveguard)
...
Config.Inventory = dependencyCheck(inventories) or 'ox_inventory'
...
Config.Phone = dependencyCheck(phones) or 'lb-phone'
...
Config.Wardrobe = dependencyCheck(wardrobes) or 'illenium-appearance'
...
Config.Garage = dependencyCheck(garages) or 'jg-advancedgarages'
...
--[[
	If this is enabled, people who do not own the house cannot open the stash.
	Please note that this is normally done with a vault code. In other words, by purchasing the security feature, you prevent thieves from gaining access. However, this configuration has been added because some players have been entering mlo houses by exploiting an emote bug.
]]
Config.StashNeedsKey = false
...
Config.AllowAdminsToCreateHouses = true -- Set to false to disable admin house creation
...
-- Config.OpenHouseMenu functions are open source in client/custom/main.lua
...
--[[
	You can set false to disable the distance check for decorate.
	Players will be teleport to another routing so there is no problem if player is too far.
	But for mlos, it'll use your created poly points to check if player is too far.
	So if you set false, its not affect the mlos.
	So make sure you set proper poly points for mlos.
]]
Config.MaximumDistanceForDecorate = 350.0 -- distance or false to disable
...
Config.Shells = {
	{
		model = 'm_sh_01_subhampro_tebex_io',
		stash = {
			maxweight = 1000000,
			slots = 5,
		},
	...
	{
		model = 'm_sh_02_subhampro_tebex_io',
		stash = {
			maxweight = 1000000,
			slots = 5,
		},
	...
	{
		model = 'm_sh_03_subhampro_tebex_io',
		stash = {
			maxweight = 1000000,
			slots = 5,
		},
	...
	{
		model = 'm_sh_06_subhampro_tebex_io',
		stash = {
			maxweight = 1000000,
			slots = 5,
		},
