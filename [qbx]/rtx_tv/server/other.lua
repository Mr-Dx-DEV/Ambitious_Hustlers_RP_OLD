if Config.TelevisionWebhook then
	local webhookurl = "https://discord.com/api/webhooks/1431033091547201697/bXEZnQMYsDT0WIu3wfN7TR2pcmN1vCPRKU5yHIgqsCiqHDMRwEECk3M-XS3LEKa-AZPh" --write webhookurl here
