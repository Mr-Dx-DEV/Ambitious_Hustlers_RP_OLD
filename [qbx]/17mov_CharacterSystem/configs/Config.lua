...
Config.PrimaryIdentifier = "license2"
...
Config.Stores = {
    [1] = {price = 50, shopType = 'clothing', coords = vector4(1693.91, 4821.81, 41.06, 109.25),  radius = 3.0, hideBlip = false },
    [2] = {price = 50, shopType = 'clothing', coords = vector4(-709.75, -153.95, 36.42, 105.44),  radius = 3.0, hideBlip = false },
    [3] = {price = 50, shopType = 'clothing', coords = vector4(-1192.41, -772.64, 16.33, 99.67),  radius = 3.0, hideBlip = false },
    [4] = {price = 50, shopType = 'clothing', coords = vector4(425.36, -807.41, 28.49, 101.17),  radius = 3.0, hideBlip = false },
    [5] = {price = 50, shopType = 'clothing', coords = vector4(-162.64, -301.98, 38.73, 257.59),  radius = 3.0, hideBlip = false },
    [6] = {price = 50, shopType = 'clothing', coords = vector4(75.74, -1391.67, 28.38, 265.76),  radius = 3.0, hideBlip = false },
    [7] = {price = 50, shopType = 'clothing', coords = vector4(-821.28, -1073.0, 10.33, 223.11),  radius = 3.0, hideBlip = false },
    [8] = {price = 50, shopType = 'clothing', coords = vector4(-1451.3, -238.38, 48.81, 47.66),  radius = 3.0, hideBlip = false },
    [9] = {price = 50, shopType = 'clothing', coords = vector4(4.11, 6511.94, 30.88, 46.79),  radius = 3.0, hideBlip = false },
    [10] = {price = 50, shopType = 'clothing', coords = vector4(618.55, 2761.18, 41.09, 173.39),  radius = 3.0, hideBlip = false },
    [11] = {price = 50, shopType = 'clothing', coords = vector4(1197.87, 2710.09, 37.22, 192.14),  radius = 3.0, hideBlip = false },
    [12] = {price = 50, shopType = 'clothing', coords = vector4(-3173.71, 1047.13, 19.86, 328.29),  radius = 3.0, hideBlip = false },
    [13] = {price = 50, shopType = 'clothing', coords = vector4(-1100.45, 2711.43, 18.11, 235.52),  radius = 3.0, hideBlip = false },
    [14] = {price = 50, shopType = 'clothing', coords = vector4(-1207.5, -1457.89, 3.36, 31.84),  radius = 3.0, hideBlip = false },
    [15] = {price = 50, shopType = 'clothing', coords = vector4(120.21, -224.81, 53.56, 296.7),  radius = 3.0, hideBlip = false },
    [16] = {price = 15, shopType = 'barber', coords = vector4(-814.3, -183.8, 36.58, 130.43),  radius = 3.0, hideBlip = false },
    [17] = {price = 15, shopType = 'barber', coords = vector4(136.8, -1708.4, 28.3, 130.43),  radius = 3.0, hideBlip = false },
    [18] = {price = 15, shopType = 'barber', coords = vector4(-1282.61, -1116.82, 5.99, 80.23),  radius = 3.0, hideBlip = false },
    [19] = {price = 15, shopType = 'barber', coords = vector4(1931.43, 3729.75, 31.84, 236.03),  radius = 3.0, hideBlip = false },
    [20] = {price = 15, shopType = 'barber', coords = vector4(1212.87, -472.89, 65.21, 61.65),  radius = 3.0, hideBlip = false },
    [21] = {price = 15, shopType = 'barber', coords = vector4(-32.97, -152.33, 56.08, 343.66),  radius = 3.0, hideBlip = false },
    [22] = {price = 15, shopType = 'barber', coords = vector4(-278.02, 6228.53, 30.7, 55.18),  radius = 3.0, hideBlip = false },
    [23] = {price = 3000, shopType = 'surgeon', coords = vector4(-460.146, -298.629, 34.911, 201.722),  radius = 3.0, hideBlip = true },
    [24] = {price = 1500, shopType = 'tattoo', coords = vector4(1321.65, -1654.16, 51.28, 340.9), radius = 3.0, hideBlip = false },
    [25] = {price = 1500, shopType = 'tattoo', coords = vector4(324.66, 180.56, 102.59, 103.23), radius = 3.0, hideBlip = false },
    [26] = {price = 1500, shopType = 'tattoo', coords = vector4(-3169.8, 1077.75, 19.83, 198.68), radius = 3.0, hideBlip = false },
    [27] = {price = 1500, shopType = 'tattoo', coords = vector4(1865.23, 3747.36, 32.03, 40.0), radius = 3.0, hideBlip = false },
    [28] = {price = 1500, shopType = 'tattoo', coords = vector4(-295.52, 6200.63, 30.49, 244.46), radius = 3.0, hideBlip = false },
}
-- Config.Stores = {
