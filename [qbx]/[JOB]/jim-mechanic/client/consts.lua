...
emergencyCosmeticTable = { -- Don't touch if you don't know what this does
    ...
    { id = 49, header = locale("checkDetails", "lightBarLabel"),        enable = Enable["Lightbar"] },
...
cosmeticTable = {
    ...
    ["externals"] = {
        ...
        { id = 49, header = locale("checkDetails", "lightBarLabel"), },
...
adminCosmeticTable = { -- Don't touch if you don't know what this does
    ...
    { id = 49, header = locale("checkDetails", "lightBarLabel"),        icon = "externals", enable = true },
