    ...
    Pillbox = {
        ...
        MedicalSupplies = {                               -- EMS Shop for supplies
            ...
            Supplies = {                                  -- Supplies
                ...
                { item = 'bobby_pin',       label = 'Bobby Pin',   price = 15 },
                { item = 'tweezers',        label = 'Tweezers',   price = 15 },
                { item = 'suturekit',       label = 'Suture Kit',   price = 15 },
                { item = 'icepack',         label = 'Ice Pack',   price = 15 },
                { item = 'burncream',       label = 'Burn Cream',   price = 15 },
                { item = 'defib',           label = 'Defibrillator',   price = 15 },
                { item = 'sedative',        label = 'Sedative',   price = 15 },
                { item = 'recoveredbullet', label = 'Recovered Bullet',   price = 15 },
