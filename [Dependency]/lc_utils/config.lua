...
Config.custom_scripts_compatibility = {
	['fuel'] = "ox_fuel",						-- [lc_fuel|ox_fuel|ti_fuel|ps-fuel|sna-fuel|cdn-fuel|LegacyFuel|okokGasStation|default|other] Fuel script Compatibility
...
Config.notification = {							-- (Only if notification is default)
	...
	['position'] = "top-center",					-- [top-left|top-center|top-right|middle-left|middle-right|bottom-left|bottom-center|bottom-right] Position of the notification on the screen
