		...
		['at_scope_small'] = {
			...
			client = {
				component = {
					...
					`COMPONENT_AT_PDT19_SCOPE_SMALL` -- pd
				},
				usetime = 2500
			}
		},
		...
		['at_scope_medium'] = {
			...
			client = {
				component = {
					...
					`COMPONENT_AT_PDMK417_SCOPE_MEDIUM` -- pd
				},
				usetime = 2500
			}
		},
